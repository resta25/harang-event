...
<h1>개인정보처리방침</h1>
<pre> 
글로비성형외과의의원(이하 “병원”)에서는 고객의 개인정보를 매우 소중하게 생각하며 정보주체의 권익을 보호하기 위하여 적법하고 적정하게 취급할 것입니다. 전기통신기본법, 전기통신사업법, 개인정보 보호법 및 동법 시행령 등 관련 법이 정하는 대로 준수하고 있습니다. “병원”은 제공하신 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보 보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
...
- 이벤트 참여시 : 닉네임, 비밀번호, 이름, 나이, 연락처, 성별, 제목, 사연, 연락가능시간, 기타 설문
2. 개인정보 수집 방법
...
4. 이벤트 참여시
글로비성형외과의원에서 골반필러 등의 상담에 활용(전화, 문자, 카카오톡등)
■ 개인정보의 처리 및 보유기간
...
- 위탁업체: (주)리스타(송명석 / resta@resta.co.kr), 프티스(개인정보 책임자 : 박환영 )
...
- 대검찰청 사이버수사과 / www.spo.go.kr / 국번없이 1301 - 경찰청 사이버안전국 / police.go.kr / 국번없이 182
