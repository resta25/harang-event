...
<pre> 
[개인정보취급방침] 
스탠탑비뇨의학과의원(이하 “병원”)에서는 고객의 개인정보를 매우 소중하게 생각하며 정보주체의 권익을 보호하기 위하여 적법하고 적정하게 취급할 것입니다. 전기통신기본법, 전기통신사업법, 개인정보 보호법 및 동법 시행령 등 관련 법이 정하는 대로 준수하고 있습니다. “병원”은 제공하신 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보 보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 
...
4. 이벤트 참여시 
스탠탑비뇨의학과의원에서 비뇨기과 상담에 활용(전화, 문자), 
...
- 위탁업체: 수탁업체 :㈜리스타(개인정보 책임자 : 대표이사 송명석 / resta@resta.co.kr)
