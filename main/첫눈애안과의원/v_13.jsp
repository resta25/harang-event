...
/* 상단 타이머 */
.time-content {padding-top: 3.2rem;}
.timer-box {color: #fff; display: flex; align-items: center; gap: 2rem; font-size: 2.4rem; border: 1px solid #797979; border-radius: 0.9rem; padding: 1.4rem 2.3rem; width: max-content; margin: 0 auto; letter-spacing: -1.23px; background: #000;}
