...
<div id="wrap">
    <form id="form-1" method="POST" accept-charset="utf-8">
        <div class="container">
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260807_HRPT_(hr)_01.jpg" alt="">
            </div>
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260807_HRPT_(hr)_02.jpg" alt="">
            </div>
        </div>

        <div class="container">
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260807_HRPT_(hr)_03.jpg" alt="">
            </div>
        </div>
                ...
                <div class="form_db">
                    ...
                    <div class="box">
                        ...
                        <div class="form_box" id="form_check">
                            <div class="topB">
                                <div class="txt"><em>강남역</em>에 위치한 <strong>치과에서</strong><br /><strong>진행하는 이벤트</strong></div>
