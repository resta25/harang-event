...
<style>
            * {margin: 0; padding: 0; box-sizing: border-box !important; font-family: 'Pretendard', sans-serif;}
            ...
            #wrap {height: 100vh; background-color:#e8e8e8; font-family: 'Pretendard';}
            #wrap .container {background: #e8e8e8;}
            ...
            .video-area > img {position: absolute; top: 0; left: 0;}
            .video-area .video-box {width: calc(100vw * (468 / 818)); max-width: 468px; padding-top: 30.05%; padding-bottom: 8.5%; margin-left: 2.2%;}
            /* .video-area .video-box {position: absolute; bottom: 10.4%; left: 2.15%; width: calc(100vw * (468 / 818)); max-width: 468px; border-radius: 16px 0 0 16px; overflow: hidden;} */

            /* 슬라이드 */
            .img-box {background-color: #fff; padding: 1% 0;}
            .swiper {width: 50%;}
            .swiper img {display: block; width: 100%;}
            .img-box .img-area {width: 35%;}

            /* 공통 */
            .hide {display: none !important;}
            .point-color {color: #1c836a; font-weight: 700;}
            ...
            .chat_set.left .chat_box {width: 6em; height: 2.3em; display: inline-block; padding: 0.4em 0.7em; background-color: #fff; transform-origin: left top; animation: .3s chatBoxSizeUp 0.5s forwards; box-shadow: 0px 5px 15px 0px rgba(153, 153, 153, 0.2)}
            .chat_set.left .chat_box .chat_txt {opacity: 0; animation: 0.3s fadeIn 0.6s forwards; line-height: 1.3; font-weight: 500;}
            ...
            .chat_set.right .chat_box {width: 8rem; padding: 0.5rem; text-align: center; font-weight: 700; background-color: #393939; color: #fff;}
            .chat_set.right .chat_box.agree_btn, .chat_set.right .chat_box.disagree_btn {display: block; cursor: pointer;}
            /* .chat_set.right .chat_box.disagree_btn { background-color: #393939; } */
            .chat_set.right .chat_box.agree_btn.selected, .chat_set.right .chat_box.input_box_changed {background-color: #1c836a; color: #fff;}
            ...
            .question_box .q_select label input:checked + .chat_box {background-color: #1c836a; color: #fff;}
            /* input 다음버튼 */
            .input_box {width: 60%; display: grid; grid-template-columns: 3fr 1fr; padding-left: 1em; border-radius: 0.5em; border: 1px solid #b4b4b4; background-color: #fff; padding: 0.5rem;}
            .input_box .next_btn {padding: 0.2em 0.7em; text-align: center; font-weight: 700; border-radius: 0.3em ; cursor: pointer; background-color: #393939; color:#fff; width: 100%;}

            /* submit */
            .form .submit {padding:0; width: 35%;}
            .form .submit input[type="image"] {width:100%;}

            /* 개별 */
            #page-3 .chat_box {width: 15rem;}
            ...
            /* 개인정보처리방침 */
            .form .agBox {width: 100%; text-align: left; font-size: 75%;}
            .form .agBox a {font-weight: normal;}
            .form .agree_txt {text-decoration: none;}

            .form input[type="checkbox"] + span:before, .form input[type="radio"] + span:before,
            .form input[type="checkbox"]:checked + span:after, .form input[type="radio"]:checked + span:after {top: 25%;}

            /* 이벤트기간, 안심문구, 대상 */
            .form .description {text-align: left; border-radius: 1rem; width: auto;}
            .form .description p,
            .form .description .ad_txt,
            .form .description span {font-size: 75%; font-weight: normal;}
            ...
            @media screen and (max-width: 500px){
                ...
                .chat_set.right .chat_box {width: 5rem;}
                .form .submit {width: 45%;}
                #page-3 .chat_box {width: 9rem;}

                .img-box {column-gap: 5%; padding: 3% 0; padding-left: 5%; }
                .swiper {width: 55%;}
                .img-box .img-area {width: 40%;}
            }
...
<div id="wrap">
    <div class="container bg_main">
        <div class="img-area video-area">
            <div class="video-box">
                <video playsinline autoplay muted loop src="//static.harang-event.com/event/v_${eventSeq}/260409_SCTM_03.mp4" type="video/mp4">
                </video>
            </div>
            <img src="//static.harang-event.com/event/v_${eventSeq}/260409_SCTM_01.png">
        </div>
        ...
        <div class="form">
			<form id="form-1" method="POST" accept-charset="utf-8">
                ...
                <div class="chat_set left" data-value="1">
                    <div class="chat_profile_01"><img src="//static.harang-event.com/event/v_${eventSeq}/260409_SCTM_02.png"></div>
                    <div class="chat_container">
                        <div class="chat_box">
                            <div class="chat_txt">
                                <div class="chat_txt">안녕하세요.<br><b class="point-color">임플란트</b>가 필요하신가요?</div>
                            </div>
                ...
                <div class="chat_profile_01"><img src="//static.harang-event.com/event/v_${eventSeq}/260409_SCTM_02.png"></div>
                    <div class="chat_container">
                        <div class="chat_box">
                            <div class="chat_txt">임플란트 혜택 받으실<br>귀하의 <span class="point-color">성함</span>을 입력해주세요.</div>
                            <div class="loader_box">
                                <span class="loader"></span>
                            </div>
                        </div>
                ...
                <div class="chat_set right hide" id="page-2" data-value="2">
                    <div class="input_box">
                ...
                <div class="chat_set left hide" data-value="3">
                    ...
                    <div class="chat_container">
                        <div class="chat_box">
                            <div class="chat_txt">임플란트 혜택 받으실<br>귀하의<span class="point-color"> 연락처</span>를 입력해주세요.</div>
                            <div class="loader_box">
                                <span class="loader"></span>
                            </div>
                        </div>
                    ...
                    <div class="chat_container">
                        <div class="chat_box">
                            <div class="chat_txt">
                                <div class="agBox">
                                    <label>
                                        <input name="agBox" type="checkbox"><span>개인정보 수집 및 이용에 관한 내용을<br> 확인하고 동의함</span><a href="#" class="agree_txt btn-agreement">[자세히 보기]</a>
                                    </label>
                                </div>
                ...
                <div class="chat_set right hide" id="page-4" data-value="4">
                    <div class="submit submit_agree">
                        <input type="image" value="" class="btn_submit" onclick="fnForm('form-1');" src="//static.harang-event.com/event/v_${eventSeq}/260409_SCTM_04.png"/>
                    </div>
                </div>
