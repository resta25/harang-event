                ...
                <div class="page_inner">
                    ...
                    <p class="paging">	
                        <label class="label-agree" onclick="pageFuc(1,$(this))">
                            <input type="radio" name="add2" value="예" class="first"><img src="//static.harang-event.com/event/v_${eventSeq}/img_01.png"></input>
                            <span class="agree">예</span>
                        </label>
                        <label class="label-disagree">
                            <input type="radio"  name="add2" value="아니오" class="close"><img src="//static.harang-event.com/event/v_${eventSeq}/img_02.png"></input>
