...
.form .agBox {margin-bottom: 15px; font-size: 90%;}
...
<div class="agBox_box">
    ...
    <p class="paging">	
        <label>
            <input type="radio" name="agBox" value="동의" class="first"><img src="//static.harang-event.com/event/v_${eventSeq}/btn_newSb_01.png"></input>
        </label>
        <label>
...
<div id="wrap"> 
    ...
    <div class="form">
        ...
        <div class="img-area" style="margin: 5% auto 0; width: 60%;"><img src="//static.harang-event.com/event/v_${eventSeq}/event_main_02.png"></div>
        <div class="img-area" style="margin-top: 5%;"><img src="//static.harang-event.com/event/v_${eventSeq}/Line_01.png"></div>
		...
		<div class="formContents">
            <section class="page" id="page-1">             
                <div class="question_box">
					...
					<div class="q_select">
						<label><input type="radio" name="tadd1" value="비용문의"><img src="//static.harang-event.com/event/v_${eventSeq}/select_off_01.png"></label>
						<label><input type="radio" name="tadd1" value="실시간 예약"><img src="//static.harang-event.com/event/v_${eventSeq}/select_off_02.png"></label>
						<label><input type="radio" name="tadd1" value="위치 문의"><img src="//static.harang-event.com/event/v_${eventSeq}/select_off_03.png"></label>
						<label><input type="radio" name="tadd1" value="기타"><img src="//static.harang-event.com/event/v_${eventSeq}/select_off_04.png"></label>
					</div>
				</div>
			</section>
			...
			<section class="page" id="page-2">
                ...
                <!-- <audio id="location3" playsinline><source src="//static.harang-event.com/event/v_${eventSeq}/audio_03.mp3" type="audio/mp3"></source></audio> -->
			</section>
		</div>
