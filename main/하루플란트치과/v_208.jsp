                ...
                <div class="page_inner">
                    ...
                    <p class="paging">	
                        <label class="label-agree" onclick="pageFuc(1,$(this))">
                            <input type="radio" name="agBox" value="동의" class="first"><img src="//static.harang-event.com/event/v_${eventSeq}/img_01.png"></input>
                            <span class="agree">예 (동의)</span>
                        </label>
                        <label class="label-disagree">
                            <input type="radio"  name="agBox" value="미동의" class="close"><img src="//static.harang-event.com/event/v_${eventSeq}/img_02.png"></input>
