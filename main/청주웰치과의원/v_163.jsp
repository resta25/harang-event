...
.top_txt strong {color: #6f3dff; font-family: 'SUIT'; font-weight: 800;}
...
.paging label.active {border-color: #6f3dff;}
...
.paging label.active span {color: #6f3dff;}
...
.form .user-box .user-info.focus {border-color: #6f3dff;}
...
.form .user-box .user-info.focus .legend {color: #6f3dff;}
...
.progress-bar {height: 100%; width: 0%; background-color: #6f3dff; transform-origin: 0 0; transition: width 0.4s cubic-bezier(.25, 0, .35, .95); max-width: 100%;}
...
<div id="wrap">
    <div class="form">
        ...
        <div class="top_txt"><strong>임플란트</strong> 안내 페이지</div>
        ...
        <div class="formContents">
            ...
            <section class="page hide section02" id="page-2">
                <div class="page_inner">
                    ...
                    <p class="q-text">
                        <strong>이름과 연락처</strong>를 남겨주시면 <br />
                        <strong>최대 혜택 상담</strong>을 도와드립니다
                    </p>
                    <p class="paging">	
                        <label class="label-agree" onclick="pageFuc(2,$(this))">
                            <input type="radio" name="" value="" class="first"><img src="//static.harang-event.com/event/v_${eventSeq}/img_03.png"></input>
                            <span class="agree">확인했습니다</span>
                        </label>
                        <label class="label-disagree">
                            <input type="radio"  name="" value="" class="close"><img src="//static.harang-event.com/event/v_${eventSeq}/img_04.png"></input>
                            <span class="disagree">괜찮습니다</span>
                        </label>
                    </p>
                </div>
            </section>
