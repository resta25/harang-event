...
.bg_main {background-color: #f7f7f7; overflow: hidden;}
.c_red {color:#fff500;}
.mb_3{margin-bottom: 3%;}
.bottom{display:none;}

.bg_main > .img-area:nth-child(1) {background-color: #fff;}
.gif-area {position: relative; display: flex; align-items: center;background-color: rgb(250, 250, 250);}
.gif-area img:nth-child(1) {position: absolute; width: 46.454767%; border-radius: 0 25px 25px 0;}
.gif-area img:nth-child(2) {width: 100%;}

#wrap {height: 100vh; background-color:#f7f7f7;}
...
.chat_set.right .chat_box {width: 10rem; text-align: center; padding: 0.969rem 0.5rem; text-align: center; font-weight: 600; background-color: #171717; color: #fff;}
.chat_set.right .chat_box.agree_btn, .chat_set.right .chat_box.disagree_btn {display: block; cursor: pointer;}
.chat_set.right .chat_box.disagree_btn { background-color: #171717; }
.chat_set.right .chat_box.agree_btn.selected, .chat_set.right .chat_box.input_box_changed {background-color: #0084e9; color: #fff;}
#page-4.chat_set.right {flex-direction: column; align-items: flex-end;}
...
.form .formContents .table_box table tr td{background-color: #f7f7f7; height: auto;}
...
.question_box .q_select label input:checked + .chat_box {background-color: #0084e9; color: #fff;}
...
.input_box .next_btn {flex-shrink: 0; padding: 0.5em 0.7em; text-align: center; font-weight: 600; border-radius: 0.5em ; cursor: pointer; background-color: #171717; color:#fff; width: max-content;}
...
.em {color: #0084e9; font-weight: 700;}
...
<div id="wrap">
    <div class="container bg_main">
        <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_01.jpg"></div>
        <div class="video-box">
            <video id="location" playsinline loop autoplay muted src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_02.mp4" type="video/mp4"></video>
            <script>setTimeout(function(){ $('#location').trigger('play'); },500);</script>
        </div>
        <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_03.gif"></div>
        ...
        <div class="form">
			...
			<div class="chat_set left" data-value="1">
				<div class="chat_profile_01"><img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_04.png"></div>
				<div class="chat_container">
					<div class="chat_box">
						<div class="chat_txt">
                            안녕하세요. <br />
                            <b class="em">임플란트 최대 혜택 페이지</b>입니다.
                        </div>
			...
			<div class="chat_set right hide question_box" data-value="1">
				<div class="q_select">
					<label><input type="radio" name="tadd1" value="네"><div class="chat_box">네</div></label>
			...
			<div class="chat_set left hide" data-value="2">
				...
				<div class="">
					<div class="chat_container">
						<div class="chat_box">
							<div class="chat_txt">최대 혜택 받으실 <br />귀하의 <b class="em">성함</b>을 입력해 주세요.</div>
							<div class="loader_box">
								<span class="loader"></span>
							</div>
						</div>
			...
			<div class="chat_set left hide" data-value="3">
				...
				<div class="">
					<div class="chat_container">
						<div class="chat_box">
							<div class="chat_txt">최대 혜택 받으실 <br />귀하의 <b class="em">연락처</b>를 입력해 주세요.</div>
							<div class="loader_box">
								<span class="loader"></span>
							</div>
						</div>
			...
			<div class="chat_set right hide" id="page-5" data-value="5">
				<div class="submit submit_agree">
					<input type="image" value="" class="btn_submit" onclick="fnForm('form-1');" src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_05.png"/>
				</div>
			</div>
		...
		<div class="container_bottom">
			<div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_06.jpg"></div>
			<div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_07.jpg"></div>
		</div>
    </div>
</div>
...
<script>   
    ...
    // add 설문 셀렉 시
    $('.question_box .q_select input[type="radio"]').on('change', function () {
        var currentValue = $(this).closest('.chat_set').data('value');
