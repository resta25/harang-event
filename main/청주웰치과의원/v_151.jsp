...
.bg_main {background-color: #f5f5f5; overflow: hidden;}
.c_red {color:#fff500;}
...
#wrap {height: 100vh; background-color:#f5f5f5;}
...
#location {position: absolute; bottom: 9.7%; left: 2.25%; width: 57.25%; border-radius: 4% 0 0 4%;}
...
.chat_set.left .chat_box {width: 6em; height: 2.3em; display: inline-block; padding: 0.4em 0.7em; background-color: #fff; transform-origin: left top; animation: .3s chatBoxSizeUp 0.5s forwards; font-family: 'Pretendard'; font-weight: 500;}
.chat_set.left .chat_box .chat_txt {opacity: 0; animation: 0.3s fadeIn 0.6s forwards; font-family: 'Pretendard'; font-size: 100%; font-weight: 500; line-height: 1.26; letter-spacing: -0.31px; color: #000;}
...
.chat_set.right .chat_box {width: 10rem; text-align: center; padding: 0.969rem 0.5rem; text-align: center; font-weight: 600; font-family: 'Pretendard'; background-color: #393939; color: #fff; line-height: 1;}
...
.chat_set.right .chat_box.agree_btn.selected, .chat_set.right .chat_box.input_box_changed {background-color: #5a6dd1; color: #fff;}
...
.question_box .q_select label input:checked + .chat_box {background-color: #5a6dd1; color: #fff;}

/* 설문 개별 */
.chat_set[data-value="2"] .q_select label:nth-child(odd) {margin-bottom: 1%;}

.input_box {width: 60%; display: flex; align-items: center; padding-left: 1em; border-radius: 1em; border: 1px solid #999; background-color: #fff; padding: 0.5rem 0.5rem 0.5rem 1rem; box-shadow: 0px 5px 10px 0 rgba(221, 221, 221, 0.3);}
.input_box input {font-family: 'Pretendard'; font-weight: 600;}
.input_box .next_btn {flex-shrink: 0; width: 10rem; padding: 0.969rem 0.5rem; text-align: center; font-weight: 500; border-radius: 0.5em; cursor: pointer; background-color: #393939; color: #fff; font-family: 'Pretendard'; line-height: 1;}
...
.em {color: #5a6dd1; font-weight: 700; font-family: 'Pretendard';}

/* 개별 */
#page-3 {flex-direction: column; align-items: end;}
#page-3 .chat_box {width: 15rem;}
#page-3 .input_box {width: 60%;}

.chat_box + p {font-family: 'Pretendard'; font-size: 165%; font-weight: 500; line-height: 1.23; letter-spacing: -0.66px; text-align: left; color: #000; margin-top: 3%; margin-left: 0.7em;}
...
/* 개인정보처리방침 */
.form .agBox {width: 100%; text-align: left; font-size: 95%; font-family: 'Pretendard'; letter-spacing: -1.33px}
.form .agBox a {font-weight: 500;}

.form .description {text-align: left; border-radius: 1rem; width: auto; margin: 0; font-family: 'Pretendard';}

.form .description p,
.form .description .ad_txt,
.form .description span {font-size: 95%; font-weight: 500; text-align: left; font-family: 'Pretendard'; letter-spacing: -1.33px}
...
@media screen and (max-width: 500px){
	...
	.chat_set.right .chat_box, .input_box .next_btn {width: 6rem; padding: 0.5rem 0.2rem;}
    .input_box {border-radius: 0.5em;}
    ...
    <div class="container bg_main">
        ...
        <div class="form">
			...
			<div class="chat_set left" data-value="1">
				<div class="chat_profile_01"><img src="//static.harang-event.com/event/v_${eventSeq}/profile.png"></div>
				<div class="chat_container">
					<div class="chat_box">
						<div class="chat_txt">
							<div class="chat_txt">안녕하세요.<br /><b class="em">치아검진</b>이 필요하신가요?
                            </div>
						</div>
				...
				<div class="">
					<div class="chat_container">
						<div class="chat_box">
							<div class="chat_txt">
                                치아검진 혜택 받으실<br />
                                귀하의 <b class="em">성함</b>을 입력해주세요</div>
							<div class="loader_box">
								<span class="loader"></span>
							</div>
						</div>
			...
			<div class="chat_set left hide" data-value="3">
				...
				<div class="">
					<div class="chat_container">
						<div class="chat_box">
							<div class="chat_txt">치아검진 혜택 받으실<br />
                                귀하의 <b class="em">연락처</b>를 입력해주세요</div>
							<div class="loader_box">
								<span class="loader"></span>
							</div>
						</div>
			...
			<div class="chat_set left hide" data-value="4">
				...
				<div class="">
					<div class="chat_container">
                        ...
                        <!-- <p>※ 장난 · 허위 · 타인정보 입력 시, 법적 처벌(5년 이하 <br />징역 · 5천만원 이하 벌금)을 받을 수 있습니다.</p> -->
					</div>
				</div>
			</div>
