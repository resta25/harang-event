...
#location {position: absolute; bottom: 9.658%; left: 4.035%; width: 55.01222%; border-radius: 4.4%;}
...
.chat_set.right .chat_box.agree_btn.selected, .chat_set.right .chat_box.input_box_changed {background-color: #ff7800; color: #fff;}
...
.question_box .q_select label input:checked + .chat_box {background-color: #ff7800; color: #fff;}
...
.em {color: #ff7800; font-weight: 700; font-family: 'Pretendard';}
        ...
        <div class="form">
			...
			<div class="chat_set left" data-value="1">
				...
				<div class="chat_container">
					<div class="chat_box">
						<div class="chat_txt">
							<div class="chat_txt">안녕하세요. <br />
                                <b class="em">임플란트</b>가 필요하신가요?
                            </div>
						</div>
			...
			<div class="chat_set left hide" data-value="2">
				...
				<div class="">
					<div class="chat_container">
						<div class="chat_box">
							<div class="chat_txt">임플란트 혜택 받으실 <br />
                                귀하의 <b class="em">성함</b>을 입력해 주세요.</div>
							<div class="loader_box">
								<span class="loader"></span>
							</div>
						</div>
			...
			<div class="chat_set left hide" data-value="3">
				...
				<div class="">
					<div class="chat_container">
						<div class="chat_box">
							<div class="chat_txt">임플란트 혜택 받으실 <br />
                                귀하의 <b class="em">연락처</b>를 입력해 주세요.</div>
							<div class="loader_box">
								<span class="loader"></span>
							</div>
						</div>
