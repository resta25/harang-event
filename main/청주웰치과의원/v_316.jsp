...
#wrap {margin:0 auto;background:#ddf474;font-family:"Pretendard",sans-serif;}
...
.form.two .form_db {width:100%; padding: 4rem 2.7rem 2.7rem; border-radius: 2.4rem; border: solid 5px #dcff00; background-color: #05070a;}
...
.formGroup .user_info.active {border-color: #0766d2;}
...
.formGroup .user_info.active .legend {color: #0766d2;}
...
.formGroup .user-agree .ag_btn .agree-label.active, .formGroup .user-agree .ag_btn a.active {color: #0766d2; border-color: #0766d2;}


.form_db > .box {padding:2.6rem 1.9rem 2.1rem;border:solid .5rem #dcff00;border-radius:var(--r24);background:rgba(5,7,10,.9);transition:all .25s cubic-bezier(0,.78,.26,1.11);}
...
.form .agBox {margin-top: 1.2rem; margin-bottom: 0; font-family: 'SUIT'; font-size: 1.4rem; letter-spacing: -0.24px; text-align: center; color: #fff; text-decoration: underline;}
...
<div id="wrap">
    <form id="form-1" method="POST" accept-charset="utf-8">
        <div class="container">
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_01.jpg" alt="">
            </div>
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_02.jpg" alt="">
            </div>
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_03.jpg" alt="">
            </div>
        </div>

        <div class="container">
            <div class="img-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260804_CJWL_(hr)_04.jpg" alt="">
            </div>
        </div>
