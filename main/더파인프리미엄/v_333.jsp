...
:root {--main-color:rgba(6,111,231,.9);--sub-color:#e5f5ff;--gap20:2rem;--gap12:1.2rem;--r20:2rem;--r24:2.4rem;}
...
.gif-area .gif {position: absolute; left: 50%; top: 55.5%; transform: translate(-50%, -50%); width: 100%;}

/* sticky 신청폼 */
.form {position:sticky;bottom:0;z-index:3;width:100%;background:transparent;}
.form.two {height:100dvh;background:rgba(0,0,0,.6);}
...
.form.two .form_db {width:100%; padding: 1.3rem 2.7rem 1.7rem; border-radius: 2.4rem; border: solid 5px #066fe7; background-color: #05070a;}
...
.form.two .form_db .banner {margin-top: 1.2rem; padding: 2.2rem; border-radius: 2.4rem; background-color: #202020; font-family: 'SUIT'; font-size: 3.7rem; font-weight: 300; line-height: 1.21; letter-spacing: -0.76px; text-align: center; color: #fff;}
.form.two .form_db .banner strong {font-weight: 800;}

/* 이름, 연락처 입력칸 */
.formGroup .user_info {width: 100%; display: flex; align-items: center; padding: 2rem 4.1rem 2.1rem; background-color: #fff; border-radius: 1.2rem; box-sizing: border-box; border: 1px solid #c6c6c6;}
.formGroup .user_info + .user_info {margin-top: 1rem;}
.formGroup .user_info.active {border-color: #066fe7;}
.formGroup .legend {flex-shrink: 0; line-height: 1; width: 11.5rem; border-right: 1px solid #c7c7c7; font-family: 'SUIT'; font-size: 2.7rem; font-weight: 700; letter-spacing: -0.6px; text-align: left; color: #0d0d0d;}
.formGroup .user_info.active .legend {color: #066fe7;}
.formGroup .inp {line-height: 1; padding-left: 3.8rem; font-family: 'SUIT'; font-size: 2.7rem; font-weight: 600; letter-spacing: -0.62px; text-align: left; color: #0d0d0d;}
...
.formGroup .user_info.user-agree .legend span {font-family: 'SUIT'; font-size: 2.7rem; font-weight: 700; line-height: 1.07; letter-spacing: -0.6px; text-align: center; color: #0d0d0d;}
...
.formGroup .user-agree .ag_btn .agree-label, .formGroup .user-agree .ag_btn a {display: block; width: 12.9rem; padding: 1.2rem 0; text-align: center; font-family: 'SUIT'; font-size: 2.7rem; font-weight: 700; letter-spacing: -0.6px; color: #969696;   border: solid 2px #dadada; background-color: #fff; line-height: 1; border-radius: 999px; transition: 0s;}
.formGroup .user-agree .ag_btn .agree-label.active, .formGroup .user-agree .ag_btn a.active {color: #066fe7; border-color: #066fe7;}


.form_db > .box {padding:2.6rem 1.9rem 2.1rem;border:solid .5rem #066fe7;border-radius:var(--r24);background:rgba(5,7,10,.9);transition:all .25s cubic-bezier(0,.78,.26,1.11);}
...
@keyframes arrow {from {transform:translateX(-.2rem);background:#fff;} to {transform:translateX(.4rem);background:#0098fe;}}
@keyframes submit_btn {from {background:var(--main-color);color:#fff;} to {background:var(--sub-color);color:#0098fe;}}


.form .agBox {width: 100%; margin-top: 0.4rem; margin-bottom: 0; font-family: 'SUIT'; font-size: 1.8rem; letter-spacing: -0.24px; text-align: center; color: #fff; text-decoration: underline;}
...
<div id="wrap">
    <form id="form-1" method="POST" accept-charset="utf-8">
        <div class="container">
            <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_01.jpg"></div>
            <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_02.gif"></div>
            <div class="video-box">
                <video id="location" playsinline loop autoplay muted src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_03.mp4" type="video/mp4"></video>
                <script>setTimeout(function(){ $('#location').trigger('play'); },500);</script>
            </div>
            <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_04.jpg"></div>
            <div class="img-area gif-area">
                <img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_05.jpg">
                <img class="gif" src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_06.gif">
            </div>
            <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_07.gif"></div>
            <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_08.jpg"></div>
            <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_09.jpg"></div>
                ...
                <div class="form_db">
                    ...
                    <div class="box">
                        ...
                        <div class="form_box" id="form_check">
                            <div class="topB">
                                <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260813_DFPM_(hr)_13.png"></div>
