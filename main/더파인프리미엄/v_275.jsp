...
.gif-area .gif_00 {top: 29.55%; width: 100%;}
...
<div id="wrap">
    <div class="container">
        <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_01.gif"></div>
        <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_02.jpg"></div>
        <div class="video-box">
            <video id="location" playsinline loop autoplay muted src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_03.mp4" type="video/mp4"></video>
            <script>setTimeout(function(){ $('#location').trigger('play'); },500);</script>
        </div>
        <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_04.jpg"></div>
        <div class="time-content">
            <div class="timer-box">
                <div class="date">
                    <img class="icon" src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_13.png" alt="">
                    <span id="year"></span>
                    <span id="month"></span>
                    <span id="day"></span>
                ...
                <div class="text-box">
                    <img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_14.png">
        ...
        <form id="form-1" method="POST" accept-charset="utf-8"> 
            <div class="form_inner">
                <div class="formGroup">
                    ...
                    <div class="submit"><input type="image" onclick="fnForm('form-1');" value="" src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_11.gif"></div>
    ...
    <div class="img-area gif-area">
        <img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_05.jpg">
        <img class="gif gif_00" src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_06.gif">
    </div>
    <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_07.jpg" alt=""></div>
    <div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_08.gif" alt=""></div>
    <div class="container">
		<div class="img-area"><img src="//static.harang-event.com/event/v_${eventSeq}/260724_DFPM_09.jpg"></div>
