...
.page_inner {padding: 0rem 1rem 2.87rem; height: 100%; box-sizing: border-box;}
#wrap {max-width: 600px; font-family: 'Pretendard'; height: 100dvh; background-image: linear-gradient(to top, rgba(224, 251, 255, 1), #bae4fa); overflow-y: hidden;}
.form {background: transparent; height: 100%;}
#form-1 {height: 100%;}
#wrap .formContents {height: calc(100% - 8.1rem); display: flex; flex-direction: column;}
.page { height: 100%; flex-grow: 1;}
.hide {display: none;}

/* 상단 타이머 */
.time-content {padding-top: 1.7rem;}
.timer-box {display: flex; align-items: center; column-gap: 0.6rem; margin: 0 2.785%; padding: 2.35% 4.5% 2.17%; opacity: 0.9; border-radius: 1rem; background-color: #fff; font-family: 'Pretendard'; font-size: 2.35rem; letter-spacing: -1.18px; text-align: left; color: #232323;}
.timer-box .text-box {margin-left: auto; width: 18rem; display: flex; align-items: center; justify-content: flex-end; gap: 0.6rem;}
.timer-box .text-box .text {font-family: 'Pretendard'; font-size: 2.35rem; font-weight: 700; letter-spacing: -1.18px; color: #232323;}
.timer-box .text-box img{ display: inline-block; animation: spin 1.1s linear infinite; transform-origin: 50% 50%; width: 13%;}
...
#page-1 .page_inner .img-area:not(.next) {width: 100%;}
#page-1 .page_inner .bottom-area {position: relative;}
#page-1 .page_inner .bottom-area .bottom-box {position: absolute; left: 0; bottom: 3%; width: 100%;}
#page-1 .page_inner .bottom-area > img {display: block; width: 78.24%; margin: 0 auto;}
#page-1 .next.img-area img {animation: pulsating 0.8s linear infinite; -webkit-animation: pulsating 0.8s linear infinite;}
...
.form .submit {width: 62.6%; margin: 0.8rem auto 0; }
...
/* 설문영역 */
.form .page-inner {padding: 0 1.7rem 1rem;}
.form .db-box {background: rgba(255, 255, 255, 0.9); padding: 2rem 2.4rem 2.6rem; border-radius: 1rem;}
...
.form .description p,
.form .description span {font-family: 'Pretendard'; font-size: 1.2rem; font-weight: 500; letter-spacing: -0.24px; text-align: center; color: #212121;}

.form .agBox {font-family: 'Pretendard'; font-size: 1.2rem; font-weight: 500; letter-spacing: -0.24px; text-align: center; color: #fff; width: 100%;}
...
.container-bottom {margin-top: auto;}
.container-bottom .img-area:nth-child(1) {width: 31%; margin: 0 auto;}
...
@media screen and (max-width: 500px) { 
    ...
    .container-bottom .img-area:nth-child(1) {width: 51%;}
}
        ...
        <div class="formContents">
            <section class="page section01" id="page-1">
                <div class="page_inner">
                    ...
                    <div class="img-area bottom-area">
                        <img src="//static.harang-event.com/event/v_${eventSeq}/event_main_02.png">
