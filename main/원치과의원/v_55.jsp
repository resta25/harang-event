...
.page_inner {padding: 3.3rem 3.6rem;}
...
#form-1 {height: 100%;}
#wrap .formContents {height: calc(100% - 9.7rem); display: flex; flex-direction: column;}
.page { height: 100%; flex-grow: 1;}
.hide {display: none;}

/* 상단 타이머 */
.time-content {padding-top: 3.7rem;}
.timer-box {color: #000; display: flex; justify-content: space-between; align-items: center; gap: 2rem; font-size: 2.4rem; border: 1px solid #d7dfda; border-radius: 0.9rem; padding: 1rem 4rem; width: 80%; margin: 0 auto; letter-spacing: -1.23px; background: #d7dfda;}
...
/* 설문영역 */
.question-box {background: #fff; border: 1px solid #565b59; font-size: 3.7rem; padding: 4.1rem 0 6.3rem; margin-top: 5.18%; border-radius: 2rem;}
.question {display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 2.4rem;}
.question img {width: 7%;}
.question .q-text {letter-spacing: -0.93px; font-weight: 600; padding: 0 1rem 2.4rem; border-bottom: 0.2rem solid #3cac66; font-family: 'Pretendard';}
.question .q-text .underline {position: relative; z-index: 1; color: #3cac66; font-weight: 700;}
...
.form .db-box {background: #fff; padding: 3.7rem 5.7rem 2.6rem; margin-top: 2.8rem; border-radius: 2rem; border: 1px solid #565b59;}
...
.form .user-box .user-info input {background: #f4f4f4; border: 2px solid #3cac66; border-radius: 8px; font-size: 200%; letter-spacing: -0.5px; font-weight: 700; padding: 1rem 2.4rem; font-family: 'Pretendard'; width: 70%;}
...
.form .agBox {color: #565b59; font-size: 1.6rem; padding: 3rem 0 2rem; width: 100%; font-family: 'Pretendard';}
...
.container input[type="radio"]:checked + .radio-circle {border-color: #3cac66;}
.container input[type="radio"]:checked + .radio-circle::before {transform: translate(-50%, -50%) scale(1);}
.container input[type="radio"]:checked + .radio-circle::before {background-color: #3cac66;}
.bage {font-size: 1.5rem; background: #3cac66; color: #f6ff62; text-align: center; padding: 0.2rem 0.8rem; border-radius: 0.4rem; font-weight: 700; position: absolute; top: -40%; left: 50%; transform: translateX(-50%); width: max-content;}
            ...
            <section class="page section01" id="page-1">
                <div class="page_inner">
                    ...
                    <div class="question-box">
                        <div class="question">
                            <img src="//static.harang-event.com/event/v_${eventSeq}/icon_01.png">
                            <span class="q-text"><span class="underline">임플란트,</span> 몇 개 필요하신가요?</span>
                        </div>
                        <div class="q-select">
