...
/* 상단 타이머 */
.time-content {}
.timer-box {color: #000; display: flex; justify-content: space-between; align-items: center; gap: 2rem; font-size: 2.4rem; border: 1px solid #fff; border-radius: 5rem; padding: 1rem 4rem; width: 80%; margin: 0 auto; letter-spacing: -1.23px; background: #eef3ff; position: absolute; top: 3%; left: 50%; transform: translateX(-50%); z-index: 99;}
