...
#form-2 .form_inner {padding: 3.75rem 4rem 3.9375rem;}
#form-1 .form_inner {padding: 1.75rem 4rem 3.9375rem;}
.form_txt {font-size: 135%; margin-top: 2rem; margin-bottom: 0; font-weight: 500; word-break: keep-all; text-align: center;}
