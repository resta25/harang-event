...
.gif-area {display: flex; align-items: center; column-gap: 24px; background-color: rgb(250, 250, 250) ;
  box-shadow: 0px 0px 20px 0px rgba(232, 232, 232, 0.55); padding-right: 3.547%;}
.gif-area img:nth-child(1) {width: 48.164%;}
.gif-area img:nth-child(2) {width: 48.796%;}
