...
#form-1 {height: 100%;}
#wrap .formContents {height: calc(100% - 8.5rem); display: flex; flex-direction: column;}
.page { height: 100%; flex-grow: 1;}
.hide {display: none;}

/* 상단 타이머 */
.time-content {padding: 3.2rem 3.6rem 0;}
.timer-box {color: #fff; display: flex; align-items: center; justify-content: space-between; gap: 2rem; font-size: 2.4rem;  border-radius: 0.9rem; padding: 0.6rem 2.3rem; width: 100%; margin: 0 auto; letter-spacing: -1.23px; background: rgba(255, 255, 255, 0.1); box-sizing: border-box;}
...
.form .db-box .question .q-text .underline {position: relative; font-weight: 800; color: #085771;}
...
.form .user-box .user-info .legend {margin-right: 1.9rem; flex-shrink: 0; width: 18.12%; text-align: justify; font-size: 160%; font-weight: 700; letter-spacing: -0.6px; text-align: justify; color: #2f2f2f; height: 3.7rem; font-family: 'Pretendard';}
.form .user-box .user-info .legend::after {content: ''; display: inline-block; width: 100%;}


.form .user-box .user-info input {border: 2px solid #085771; border-radius: 2.6rem; font-size: 2rem; letter-spacing: -0.5px; font-weight: 700; padding: 1.5rem 2rem; padding-right: 0; }
            ...
            <section class="page section01" id="page-1">
                <div class="page_inner">
                    ...
                    <div class="question-box">
                        <div class="question">
                            <span class="q-text"><span class="underline">노안</span>혹은 <span class="underline">백내장</span> 증상이<br/>있으신가요?</span>
                        </div>
                        <div class="q_select">
